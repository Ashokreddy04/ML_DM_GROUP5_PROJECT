...
def test(checkpoint_path, dataloader, model, device, output_dir, args):
    ...
    with torch.no_grad():
        ...
        for batch_id, sample_batched in enumerate(dataloader):
            ...
            preds = model(images)
            #print('Test Images Passed to Model')
...
def main(args):
    ...
    dataset_val = TestDataset(args.input_val_dir,args.src_dir,
    ...
    if args.is_testing:
        ...
        output_dir = os.path.join(args.res_dir, args.train_data+"2"+ args.test_data,args.src_dir)
